...
parser.add_argument('--root_path', type=str,
                    default='/home/centos/Farhan/pickle/ultrasound_2d/data/h5_ultrasound_ddti', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='/pyramid_net_label_DDTI_1', help='experiment_name') #change everytime for different folds
...
def train(args, snapshot_path):
    ...
    db_train = BaseDataSets(base_dir=args.root_path, split="train", num=509, transform=transforms.Compose([
...
#         total_slices, labeled_slice))
    labeled_idxs = list(range(509))
    unlabeled_idxs = list(range(1,509))
