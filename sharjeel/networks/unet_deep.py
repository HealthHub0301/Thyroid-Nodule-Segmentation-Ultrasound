...
class Encoder(nn.Module):
    def __init__(self, params):
        ...
        self.down1_const = ConvBlock(self.ft_chns[1], self.ft_chns[1], self.dropout[1])
        
        self.down2 = DownBlock(self.ft_chns[1], self.ft_chns[2], self.dropout[2])
        self.down2_const = ConvBlock(self.ft_chns[2], self.ft_chns[2], self.dropout[2])
        
        self.down3 = DownBlock(self.ft_chns[2], self.ft_chns[3], self.dropout[3])
        self.down3_const = ConvBlock(self.ft_chns[3], self.ft_chns[3], self.dropout[3])
        
        self.down4 = DownBlock(self.ft_chns[3], self.ft_chns[4], self.dropout[4])
        self.down4_const = ConvBlock(self.ft_chns[4], self.ft_chns[4], self.dropout[4])

    def forward(self, x):
        x0 = self.in_conv(x)
        x1 = self.down1(x0)
        x1 = self.down1_const(x1)
        
        x2 = self.down2(x1)
        x2 = self.down2_const(x2)
        
        x3 = self.down3(x2)
        x3 = self.down3_const(x3)
        
        x4 = self.down4(x3)
        x4 = self.down4_const(x4)
...
class Decoder(nn.Module):
    def __init__(self, params):
        ...
        self.up1 = UpBlock(self.ft_chns[4], self.ft_chns[3], self.ft_chns[3], dropout_p=0.1)
        self.up1_const = ConvBlock(self.ft_chns[3], self.ft_chns[3], dropout_p = 0.1)
        
        self.up2 = UpBlock(self.ft_chns[3], self.ft_chns[2], self.ft_chns[2], dropout_p=0.1)
        self.up2_const = ConvBlock(self.ft_chns[2], self.ft_chns[2], dropout_p = 0.1)
        
        self.up3 = UpBlock(self.ft_chns[2], self.ft_chns[1], self.ft_chns[1], dropout_p=0.1)
        self.up3_const = ConvBlock(self.ft_chns[1], self.ft_chns[1], dropout_p = 0.1)
        
        self.up4 = UpBlock(self.ft_chns[1], self.ft_chns[0], self.ft_chns[0], dropout_p=0.1)
        self.up2_const = ConvBlock(self.ft_chns[0], self.ft_chns[0], dropout_p = 0.1)
