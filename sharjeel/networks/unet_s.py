...
class ConvBlock_dil(nn.Module):
    """two convolution layers with batch norm and leaky relu"""

    def __init__(self, in_channels, out_channels, dropout_p):
        super(ConvBlock_dil, self).__init__()
        self.conv_conv = nn.Sequential(
...
class Encoder(nn.Module):
    def __init__(self, params):
        ...
        self.in_conv1 = ConvBlock_dil(self.in_chns, self.ft_chns[0], self.dropout[0])
        self.in_conv2 = ConvBlock_dil(self.ft_chns[0], self.ft_chns[0], self.dropout[0])
...
class Decoder(nn.Module):
    def __init__(self, params):
        ...
        self.conv_down = nn.Sequential(
            nn.Conv2d(2*self.ft_chns[0], self.ft_chns[0], kernel_size=1),
