...
def train(args, snapshot_path):
    ...
    model_path = "/home/azka/sharjeel/Thyroid/code/saved_models_best/unet_urpc_best_stage1_model.pth"
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss = (supervised_loss)**(1/3) + consistency_weight * consistency_loss
            optimizer.zero_grad()
            loss.backward()
            optimizer.step()
